...
RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/sdkmanager "platforms;android-27"

RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/sdkmanager "platform-tools"

RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/sdkmanager "emulator"

RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/sdkmanager "system-images;android-27;google_apis;x86"
